...
export async function GET(req: NextRequest) {
  ...
  const checks: SecurityCheck[] = [
    ...
    },
    {
      ...
      status: 'pass',
      details: 'CSP and companion browser security headers are configured in next.config.js ✓',
      severity: 'medium',
    },
    {
      id: 'rate_limiting',
      ...
      status: 'warning',
      details: 'Selected routes use best-effort process-local limits; deployment-wide enforcement is not configured',
      severity: 'medium',
    },
    {
      id: 'input_validation',
      ...
      status: 'warning',
      details: 'Runtime bounds are route-specific; TypeScript types alone do not validate request payloads',
      severity: 'medium',
    },
    {
      id: 'secret_in_client',
    ...
    },
    {
      ...
      status: 'pass',
      details: 'CI enforces the reviewed production advisory allowlist and rejects drift ✓',
      severity: 'medium',
    },
  ]
