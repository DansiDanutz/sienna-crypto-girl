...
export async function GET(req: NextRequest) {
  ...
  const checks: SecurityCheck[] = [
    ...
    },
    {
      ...
      status: 'pass',
      details: 'Sensitive and compute-heavy API routes enforce scoped request limits ✓',
      severity: 'medium',
    },
    {
      id: 'input_validation',
      ...
      status: 'pass',
      details: 'Financial and AI routes enforce bounded runtime validation before compute ✓',
      severity: 'medium',
    },
    {
      id: 'secret_in_client',
